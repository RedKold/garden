...
│ layout   │ SBHD            │ THD          │
├──────────┼─────────────────┼──────────────┤
│ strategy │ temperature     │ capping      │
├──────────┼─────────────────┼──────────────┤
│ causal   │ True            │ False        │
├──────────┼─────────────────┼──────────────┤
│ GQA      │ 1=1 (no repeat) │ 2:1 (repeat) │
└──────────┴─────────────────┴──────────────┘
```


# Fix?
![image.png|400](https://kold.oss-cn-shanghai.aliyuncs.com/20260726155135.png)


## THD 的问题：dropout 需要对每一个 sequence 做（这样才是等价的）
