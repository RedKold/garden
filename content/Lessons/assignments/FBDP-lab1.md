...
- 此报告已经发布在我的个人博客，[点此访问](https://redkold.github.io/2025/10/10/FBDP-lab1/)，欢迎评论指正问题。也期待老师反馈。
...
- ![image.png|400](https://kold.oss-cn-shanghai.aliyuncs.com/20251010114235.png)
- 结果正常。
...
- `wordcount`: 任务的名称，告诉 JAR 包运行哪个示例程序。
- `/user/wordcount_input`: 我们在步骤一中创建的 HDFS 输入路径。
- `/user/wordcount_output`: **MapReduce 任务将结果写入的 HDFS 输出路径。** **注意：此目录在运行前不能存在！**



![image.png|800](https://kold.oss-cn-shanghai.aliyuncs.com/20250925170958.png)
...
### 补充：启动 `JobHistory` 服务
可以查看 JobHistory。默认端口 `19888`, 注意端口映射
```bash
mr-jobhistory-daemon.sh start historyserver
```


![image.png|400](https://kold.oss-cn-shanghai.aliyuncs.com/20251016154635.png)
